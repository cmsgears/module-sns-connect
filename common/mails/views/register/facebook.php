...
<table cellspacing='0' cellpadding='2' border='0' align='center' width='805px' style='font-family: Calibri; color: #4f4f4f; font-size: 14px; font-weight: 400;'>
	<tbody>
		...
		<tr>
			<td>
				<br/>Thank you for registering with <?=$siteName?> using your facebook profile. You can also login using your email by activating your account. Activate your account using the below mentioned details:
			</td>
		</tr>
		<tr>

...
<table cellspacing="0" cellpadding="0" border="0" margin="0" padding="0" width="80%" align="center" class="ctmax">
	...
	<tr>
		<td>
			<font face="Roboto, Arial, sans-serif">Thank you for registering with <?= $siteName ?> using your Twitter Account. You can also login using your email by activating your account. Activate your account using the below mentioned details:</font>
		</td>
	</tr>
	<tr><td height="20"></td></tr>
	<tr>
